...
<div class="log_s_container">
    <%
        ...
        try {
            ...
            String sql = "SELECT * FROM admin WHERE admin_email = ? AND admin_passwerd = ?";
            ...
            if (rs.next()) {
    %>
                <div class="container mt-5 log_s_success">Login successful! Welcome,!</div>
                <a href="admin_dashboard.jsp" class="log_s_btn">Go to ADMIN Dashboard</a>
    <%
            } else {
    %>
